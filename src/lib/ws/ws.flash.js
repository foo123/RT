/**
*   WebSocket implementation using Flash
**/
(function(window) {
...
else if (window.WebkitWebSocket)
{
    // Webkit.
...
*/
function WebSocket(url, protocols, proxyHost, proxyPort, headers)
{
    var self = this;
    ...
    else if ("string" === typeof protocols)
    {
        protocols = [protocols];
    }
